...
"listMessage":{
"title":"ʜɪ ʙʀᴏ ᴛʜɪs ɪs ꪶ͢𝑰𝑨𝑴 ͢͢𝐴𝑀𝐸𝐸𝑁ꫂ ᴍᴇɴᴜ","description":`${""}
     ʜɪ ʙʀᴏ  ${pushname}     
╔༆ᴄʀᴇᴀᴛᴏʀ⟼ꪶ͢𝑰𝑨𝑴 ͢𝐴𝑀𝐸𝐸𝑁ꫂ
║༄ᴠᴇʀsɪᴏɴ⟼3.0
║༄ʙᴏᴛɴᴀᴍᴇ⟼ꪶ͢𝑨𝑴𝑬𝑬𝑵 𝑺𝑬𝑹-𝑩𝑶𝑻ꫂ
║༄ᴘʀᴇғɪx⟼(ᴍᴜʟᴛɪ ᴘʀᴇғɪx)
...
break
				...
				var bc = body.slice(6)
					...
					if (isMedia && !mek.message.videoMessage || isQuotedAudio) {
						...
						buff = await denz.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							denz.sendMessage(_.jid, buff, audio, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `${bc}`, orderTitle: `${bc}`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}, mimetype: 'audio/mp4', duration: 00001, ptt: true })
						}
